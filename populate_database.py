...
User1 = User(name="Robo Barista", email="tinnyTim@udacity.com",
             img_url="https://pbs.twimg.com/profile_images/2671170543/"
...
item1 = Item(
       ...
       description="Kick your game up a notch with the Nike Mercurial Veer "
                   "soccer ball! The 26-panel construction provides strength "
                   "and symmetry to this colorful ball. Its bold design makes "
                   "it easy to see when it's flying into the goal.",
       price="$25.00",
...
item2 = Item(
       ...
       description="Your rising star will play like the pros in these adidas "
                   "kids' Messi 15.3 IN J low soccer shoes. They're made with "
                   "a 3D synthetic leather upper and an indoor-optimized "
                   "outsole for total comfort and control even when the "
                   "pressure's on.",
       price="$55.00",
       img_url="http://www.sportsauthority.com/graphics/product_images/"
               "pTSA-19856023nm.jpg",
...
item3 = Item(
       ...
       description="Play fearlessly without worrying about getting hurt in "
                   "these Nike adult Neymar Mercurial Lite soccer shin "
                   "guards. Developed with the input of the star player "
                   "himself, these guards feature a contoured left- and "
                   "right-specific design for the perfect anatomical fit. The "
                   "dense foam backing and low-profile shell dampen painful "
                   "impact for max protection.",
       price="$55.00",
       img_url="http://www.sportsauthority.com/graphics/product_images/"
...
item4 = Item(
       ...
       description="These Nike adult Classic goalkeeper gloves supply "
                   "everything you need to keep the ball from slipping "
                   "through. They're designed with a traditional cut for "
                   "complete comfort and smooth latex foam for excellent "
                   "grip. A Tri-Vario wraparound wristband supplies a "
                   "customized fit and allows for easy adjustments on the "
                   "pitch.",
       price="$55.00",
       img_url="http://www.sportsauthority.com/graphics/product_images/"
               "pTSA-21028790p275w.jpg",
...
item1 = Item(
       ...
       description="The curling stone (also sometimes called a rock in North "
                   ...
                   "Curling Federation, which requires a weight between 38 "
                   "and 44 pounds (17 and 20 kg) a maximum circumference of "
                   "36 inches (910 mm) and a minimum height of 4.5 inches "
                   "(110 mm).",
       price="$105.00",
...
item1 = Item(
       ...
       description="The Barnett 25 pound Banshee Quad Compound Set features "
                   "an all new soft touch grip, an ambidextrous reinforced "
                   "handle and is offered in an eye catching color for the "
                   "beginner. The set includes 2 target arrows, finger "
                   "rollers, and an adjustable sight.",
       price="$105.00",
...
item1 = Item(
       ...
       description="Get ready for the zombie apocalypse with this crossbow"
                   " just like the one Shane owns. Drive tons of arrows "
                   "through mushy zombie heads with indiscriminate force.",
       price="$195.00",
